...
if (!empty($_POST)) {
    ...
    if (!empty($_POST)) {
      ...
      if ($item_img !='') {
        $sql = 'INSERT INTO `items`(`content`,`item_img`)VALUES(?,?)';

        $data = [$content,$item_img['user_id']];
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="thumbnail">
            ...
            <img src="user_profile_img/IMG_1380.JPG" alt="..." class=""> </a>
        </div>
    </div>
                            ...
                            <div class="feed_form thumbnail">
                                <form method="POST" action="">
                                    ...
                                    <?php if(isset($errors['content']) && $errors['content'] == 'blank'): ?>
                                        <p class="text-danger">文字を入力してください</p>         <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if (isset($errors['item_img'])&& $errors
                                    ['item_img'] == 'blank'):?>
    ...
    <script src="//code.jquery.com/jquery-1.11.1.min.js">選択する</script>
</body>
</html>
